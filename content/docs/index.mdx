...
<Callout type="info" title="Integrate with one prompt">
Copy this prompt into your AI coding agent (Claude Code, Cursor, OpenCode, Codex, etc.) — it reads the docs, installs the SDK, wraps your tools, and generates rules. [Full details →](/docs/getting-started/quick-start#ai-agent-integration)
