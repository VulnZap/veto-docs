...
<Callout type="info" title="Let your AI agent handle it">
Copy the integration prompt, paste it into your coding agent (Claude Code, Cursor, OpenCode, Codex, etc.), and it will install Veto, wrap your tools, and generate rules automatically. [See details →](/docs/getting-started/quick-start#ai-agent-integration)
