...
| **Self-hosted** | `Veto.init({ endpoint: "https://..." })` | Enterprises with data residency requirements. Validation server on your infrastructure; dashboard via [Veto Cloud](https://runveto.com). |
