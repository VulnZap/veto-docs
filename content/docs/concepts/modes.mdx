...
**What it does:**
- Runs the validation server (deterministic + LLM policies, approval workflows, decision logging) on your infrastructure
- The `apiKey` authenticates against your self-hosted server
- All data stays within your network

The self-hosted server covers the validation API. The dashboard and analytics UI are available with [Veto Cloud](https://runveto.com).
